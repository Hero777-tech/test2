    ...
    <Wrapper>
      <div className="container grid grid-two-column">
        <div className="section-hero-data">
          <p className="hero-top-data">Innovate Solution for Your Business with</p>
          <h1 className="hero-heading">DIGITAL MARK</h1>
          <p className="hero-para">
          Elevating Brands Through Innovative Web Design and Strategic Social Media Engineering. 
